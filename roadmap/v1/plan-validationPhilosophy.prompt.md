...
### Step 8: Update Agent Regulation compliance-audit skill

Agent Regulation audits governance metadata. It should:
...
**Relevant file:** `agents/agent-regulation/skills/compliance-audit/SKILL.md`
...
- `agents/agent-regulation/skills/compliance-audit/SKILL.md` — governance audit language (Step 8)
