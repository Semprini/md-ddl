# **MD‑DDL Specification (Draft 0.1)**  
...
MD‑DDL is a **Markdown‑first**, **AI‑friendly**, **Git‑native** standard for defining logical data models, domains, entities, attributes, enums, and relationships. It is designed to be readable by humans, generatable by AI, and compilable into:
...
MD‑DDL uses Markdown structure as the primary syntax, with YAML or JSON blocks for structured definitions.
...
These components may be defined together or separately across multiple files. This separation is intentional: it supports both human readability and AI context management. Similar to Anthropic's concept of "skills" MD‑DDL allows AI systems to load only the relevant parts of the model rather than the entire knowledge base at once.
...
- contain the section data directly, or
- contain links to separate files that hold the detailed definitions.
